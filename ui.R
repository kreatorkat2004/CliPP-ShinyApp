...
ui <- fluidPage(
  ...
  # Add custom JavaScript for additional button handling
  tags$head(
    tags$script(HTML("
      $(document).on('click', '#Submit', function() {
        Shiny.setInputValue('tcga-submit', Math.random());
      });
      
      $(document).on('click', '#Submit_PCAWG', function() {
        Shiny.setInputValue('pcawg-submit', Math.random());
      });
    "))
  ),
                                   ...
                                   tags$div(
                                     ...
                                     sidebarLayout(
                                       sidebarPanel(
                                         ...
                                         # Use both IDs to ensure we can catch the event 
                                         actionButton("Submit", "Submit", class = "btn-primary", 
                                                      onclick = "Shiny.setInputValue('tcga-submit', Math.random())"),
                                   ...
                                   tags$div(
                                     ...
                                     sidebarLayout(
                                       sidebarPanel(
                                         ...
                                         # Use both IDs to ensure we can catch the event
                                         actionButton("Submit_PCAWG", "Submit", class = "btn-primary",
                                                      onclick = "Shiny.setInputValue('pcawg-submit', Math.random())"),
